...
class Robot private constructor(private val context: Context) {
    ...
    fun getMapData(): MapDataModel? {
        ...
        Log.d(TAG, "getMapData() - mapDataModel is null:${mapDataModel == null}")
        return mapDataModel
    }
    ...
    fun resetMap(allFloor: Boolean): Int {
        try {
            val resp =
                sdkService?.resetMap(applicationInfo.packageName, allFloor)?.toIntOrNull() ?: 0
