package com.rhizo.libcontrol.call.net.netty;//package com.keep.myapplication.net.netty;
//
...
//        Message message = gson.fromJson(str, Message.class);  //同一类中不需要进行导包
//
//////        Log.e("ccc","信息流" + str);
////        //只有发送文字信息的时候才会返回对方ip。
////        //对应各自的回调。
////        if (message.getMsgtype().equals(Message.MES_TYPE_SIGNAL)) {
////            if (frameCallback != null) {
////                message.setMsgIp(packet.sender().getAddress().getHostAddress());
////                frameCallback.onSignal(message);
//////                frameCallback.onGetRemoteIP(packet.sender().getHostString());
////            }
////        } else if (message.getMsgtype().equals(Message.MES_TYPE_NOMAL)) {
////            if (frameCallback != null) {
////                frameCallback.onMessage(packet.sender().getAddress().getHostAddress(), message.getMsgBody());
...
////        void onSignal(Message msg); //返回文本信息
////
////        void onMessage(String ip, String msg);
////
